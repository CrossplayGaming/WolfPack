...
// Wolf tics. Text is the game's own font chunk 2 (extracted height 13 —
...
// entirely — it paints the whole display and switches to MENUSONG
...
// Read This! — the T_HELPART article through the existing renderer
